 ...
 */
public class FCriterio extends javax.swing.JFrame {

    /**
     * Creates new form FCriterio
     */
    public FCriterio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icon/ups.jpg"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (!(txtCodigo.getText().equals("") || txtNombre.getText().equals(""))) {
            Criterio objA = new Criterio();
            objA.setId_criterio(txtCodigo.getText().trim());
            objA.setNombre_criterio(txtNombre.getText().trim());
            if (new IngCriterio().Guardar(objA)) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FCriterio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
