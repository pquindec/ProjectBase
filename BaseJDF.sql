...
create user Miranda
for login Miranda
with default_schema=ini
GO
-- ESQUEMA
create schema ini authorization Miranda;
GO
--PRIVILEGIOS
GRANT CREATE PROC,EXECUTE,CREATE TABLE, CREATE ROLE, SELECT,INSERT,UPDATE,DELETE TO Miranda;
GO
--LOGIN 
create login DRizzo
with password='1234',
...
create user DRizzo
for login DRizzo
with default_schema=hi
GO
-- ESQUEMA
create schema hi authorization DRizzo;
GO
--PRIVILEGIOS
GRANT CREATE PROC,EXECUTE,CREATE TABLE, CREATE ROLE, SELECT,INSERT,UPDATE,DELETE TO DRizzo;
GO
--LOGIN 
create login Franco
with password='1234',
...
create user Franco
for login Franco
with default_schema=mini
GO
-- ESQUEMA
create schema mini authorization Franco;
GO
--PRIVILEGIOS
GRANT CREATE PROC,EXECUTE,CREATE TABLE, CREATE ROLE, SELECT,INSERT TO Franco;